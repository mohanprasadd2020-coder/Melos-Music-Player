    ...
    >
      <div className="relative mb-3">
        {playlist.image ? (
          ...
          <div className="w-full aspect-square rounded-md shadow-md-elevated bg-gradient-to-br from-secondary to-accent flex items-center justify-center">
        ...
        {onDelete && (
          <div className="absolute top-2 right-2">
            ...
            {showMenu && (
              <div className="absolute right-0 top-8 bg-card border border-border rounded-md shadow-lg-card z-10 min-w-[120px]">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    setShowMenu(false);
